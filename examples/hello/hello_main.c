...
port is configured as functional pin, the undefined value will be read.
    *aaaa |= (1 << 18);  // Set Bit 18 for PD18
    *aaaa |= (1 << 19);  // Set Bit 19 for PD19
    *aaaa |= (1 << 20);  // Set Bit 20 for PD20
    printf("aaaa=0x%x\n", *aaaa);
#endif  //  NOTUSED
